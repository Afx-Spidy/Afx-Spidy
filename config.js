...
module.exports = {
    ...
    ALIVEBTN: process.env.ALIVE_BUTTON === undefined ? 'ᴇɴɢᴀɴᴇʏᴜɴᴅ spidy sᴇʀ🌝' : process.env.ALIVE_BUTTON,
    ...
    OWNER: process.env.OWNER_NAME === undefined ? '💖Spidy Ser💖' : process.env.OWNER_NAME,
    BC: process.env.BROADCAST_NAME === undefined ? 'ɪ̄.ᴀᴍ/ꪶ͢spidy sᴇʀꫂ⁩' : process.env.BROADCAST_NAME,
    ...
    ALL: process.env.ALL_CAPTION === undefined ? 'Made By SPIDY SER' : process.env.ALL_CAPTION,
    MENTION: process.env.TAG_REPLY === undefined ? '919961174974@s.whatsapp.net' : process.env.TAG_REPLY,
    ...
    LOGO_NAME: process.env.LOGO_NAME === undefined ? 'Spidy Ser' : process.env.LOGO_NAME,
    INBO: process.env.INBO_BLOCK === undefined ? 'false' : process.env.INBO_BLOCK,
    INBO1: process.env.INBO_BLOCK === undefined ? 'true' : process.env.INBO_BLOCK,
    ABU: process.env.ABU_CAPTION === undefined ? 'ᴍᴀᴅᴇ ʙʏ SPIDY sᴇʀ' : process.env.ABU_CAPTION,
    DISBGM: process.env.DISABLE_JID_BGM_FILTER === undefined ? false : process.env.DISABLE_JID_BGM_FILTER,
    STICKERP: process.env.AUTO_STICKER === undefined ? true : convertToBool(process.env.AUTO_STICKER),
    DISSTICKER: process.env.DISABLE_STICKER === undefined ? false : process.env.DISABLE_STICKER,
    BOT: process.env.BOT_NAME === undefined ? '⊢‒‒‒ 💝 Spidy Ser 💝 ‒‒‒⊣' : process.env.BOT_NAME,
    ...
    TALKING_SPIDY: process.env.TALKING_SPIDY === undefined ? 'false' : process.env.TALKING_SPIDY,
    ...
    ALLEMOJI: process.env.CMD_LIST === undefined ? 'spidy💞/💝/✨/📝' : process.env.CMD_LIST,
